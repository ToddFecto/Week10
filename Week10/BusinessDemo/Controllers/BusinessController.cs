...
namespace BusinessDemo.Controllers
{
    public class BusinessController : Controller
    {
         ...
         *      Routes
         *      
         *      /business  -- list all the departments (calls Index view
         ...
         *      /business/addform -- preset the user with a form to add an employee
         *      /business/addemp -- create a new employee
         *      /business/editform?empid=5 -- preset the user with a form to edit an employee
        ...
        public IActionResult delete(int id)
        {
            ...
            //List<Department> results = DAL.FetAllDepartments();
